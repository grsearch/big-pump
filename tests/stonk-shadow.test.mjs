...
test('C exits on FDV below 10k or 15m even without X; no inherited fixed profit/stop',()=>{
  const p={cost:50,quantity:50,openedAt:now,highValue:0,trailingActive:false};
  assert.equal(stonkExit({...p},t({fdv:9999}),diffusionDefaults,now),'FDV 跌破 $10,000');
